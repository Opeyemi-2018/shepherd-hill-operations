    ...
    const fetchFormDetail = async () => {
      ...
      try {
        const res = await fetch(
          `${process.env.NEXT_PUBLIC_API_URL}/api/operations/retainership/form/${code}`,
          {
    ...
    <div className="p-4">
      ...
      >
        ...
        <div className="border border-t-0 border-black">
          ...
          <div className="bg-[#FAB435] text-black font-bold px-2 py-1 text-center border-b border-black text-xs">
            CONTRACT DETAIL:{" "}
        ...
        {formData.signatories.map((sig: Signatory, index: number) => {
          ...
          return (
            <div
              key={sig.id || index}
              className="flex text-xs border-b border-black last:border-b-0 min-h-[60px]"
            >
              ...
              <span className="flex-1 px-2 py-3 border-r border-black flex items-center">
                {isSigned && signatureUrl ? (
                  ...
                  <div className="w-full border border-dashed border-gray-400 h-10 flex items-center justify-center text-gray-400 text-xs">
